...
.main div[data-testid="stColumn"]:has(.live-workspace-nav){align-self:flex-start!important;min-height:1px!important;overflow:visible!important}
.live-workspace-nav{position:fixed;z-index:20;top:20px;left:max(30px,calc((100vw - 1780px)/2 + 30px));width:min(307px,calc((100vw - 76px)*.18));max-height:calc(100vh - 40px);box-sizing:border-box;padding:20px 14px 16px;background:linear-gradient(180deg,#061a2e 0%,#08243b 55%,#071c30 100%);border:1px solid rgba(89,211,239,.18);border-radius:14px;box-shadow:0 8px 24px rgba(4,22,39,.10);color:#eaf7fb;overflow-x:hidden;overflow-y:auto;scrollbar-width:thin;scrollbar-color:rgba(77,211,235,.38) transparent}
...
@media(max-width:900px){.main .block-container{padding:18px 18px 40px!important}.live-workspace-nav{position:relative;z-index:auto;top:auto;left:auto;width:100%;max-height:none;margin:0 0 16px;overflow:visible}.live-workspace-nav__item{display:inline-block;width:calc(50% - 6px);box-sizing:border-box;vertical-align:top}}
