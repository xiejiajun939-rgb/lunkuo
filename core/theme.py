...
def apply_global_theme():
    ...
    button[data-testid="stBaseButton-primary"],.stButton>button[kind="primary"]{color:#fff!important;border-color:transparent!important;background:linear-gradient(135deg,#1767a5,#1687c9)!important;box-shadow:0 6px 16px rgba(23,110,174,.24)!important}
